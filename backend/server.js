...
// Import Cart and Checkout Routes claude
...
//// Add Cart and Checkout routes chatgpt
//app.use('/api/cart', authMiddleware, cartRoutes); // Apply authMiddleware to cart routes
//app.use('/api/checkout', authMiddleware, checkoutRoutes); // Apply authMiddleware to checkout route
